      ...
      <div className="w-full max-w-md animate-in slide-in-from-bottom-4 duration-700 ease-out">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-2xl shadow-black/20 animate-in slide-in-from-bottom-4 duration-700 delay-500 ease-out">
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Error Alert */}
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-2xl p-4 animate-in slide-in-from-top-2 duration-300 ease-out">
            ...
            <div className="space-y-2 animate-in slide-in-from-bottom-2 duration-500 delay-600 ease-out">
              <label htmlFor="email" className="block text-sm font-bold text-slate-900 uppercase tracking-wide">
                Email Address
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 rounded-2xl border-2 bg-slate-50 transition-all duration-200 text-slate-900 placeholder-slate-400 font-medium focus:outline-none focus:ring-0 focus:bg-white focus:border-blue-500 disabled:opacity-75 disabled:cursor-not-allowed"
                  disabled={isLoading}
                  required
                />
              </div>
              {validationErrors.email && (
                <div className="flex items-center gap-2 text-red-600 text-sm font-medium animate-in slide-in-from-top-1 duration-300 ease-out">
            ...
            <div className="space-y-2 animate-in slide-in-from-bottom-2 duration-500 delay-700 ease-out">
              <label htmlFor="password" className="block text-sm font-bold text-slate-900 uppercase tracking-wide">
                Password
              </label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
            ...
            <div className="flex justify-end animate-in slide-in-from-bottom-1 duration-400 delay-800 ease-out">
              <button 
                type="button" 
                className="text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors disabled:cursor-not-allowed"
                disabled={isLoading}
              >
